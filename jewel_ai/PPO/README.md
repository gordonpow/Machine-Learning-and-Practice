...
6.  [API 規格說明 (API Specification)](#6-api-規格說明-api-specification)
    * [神經網路模型 (Neural Network)](#61-神經網路模型-neural-network)
    * [PPO 代理 (Reinforcement Learning Agent)](#62-ppo-代理-reinforcement-learning-agent)
    * [遊戲環境 (Environment)](#63-遊戲環境-environment)
    * [專家系統 (Expert Solver)](#64-專家系統-expert-solver)
    * [多核心環境管理器 (Multiprocessing Environment)](#65-多核心環境管理器-multiprocessing-environment)
    * [測試與驗證模組 (Testing Interface)](#66-測試與驗證模組-testing-interface)
