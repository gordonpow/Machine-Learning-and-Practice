...
def main():
    ...
    for ep in range(EPISODES):
        ...
        # Episode metrics (but recorded by steps)
        writer.add_scalar("Episode/Reward", total_reward, global_step)
        writer.add_scalar("Episode/Steps", ep_steps, global_step)
        writer.add_scalar("Episode/Cleared", total_cleared, global_step)
        writer.add_scalar("Episode/MaxCombo", max_combo, global_step)

        # reward component breakdown (step-based)
